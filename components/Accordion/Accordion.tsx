  ...
  return (
    <div>
      <div
        ...
        role="button"
      >
        <p className="text-gray-600 uppercase text-sm truncate">{title}</p>
        {collapsed ? (
          <MdOutlineExpandMore className="text-gray-600 w-6 h-6" />
        ) : (
          <MdOutlineExpandLess className="text-gray-600 w-6 h-6" />
        )}
      </div>
