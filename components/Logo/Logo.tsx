  ...
  return (
    <div className="w-full h-14 flex justify-center items-center pointer-events-none flex-shrink-0">
      <div className="flex flex-col items-center justify-center relative bottom-7">
        <MdAccessTime className="spin-animation ml-2 w-10 h-10 text-mblue-500 absolute top-0" />
        <div
          className="leading-0 font-medium uppercase text-mblue-500 leading-none absolute top-2"
